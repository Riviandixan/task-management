document.addEventListener('DOMContentLoaded', () => {
  ...
  function displaAllTasks(tasks = existingTasks) {
    if (tasks.length === 0) {
      ...
      tasks.forEach(task => {
        ...
        const dateFormat = formatDate(task.createdAt);
        ...
        <div class="task-card flex flex-col gap-5">
                              <div class="flex gap-3 items-center">
                                  ...
                                  <div class="flex flex-col">
                                      ...
                                      <p class="text-sm leading-[21px] text-taskia-grey">Created at ${dateFormat}</p>
                                  </div>
                              </div>
